...
const Header = () => {
  ...
  return (
    <>
      <header className="h-[68px] flex-shrink-0 bg-card border-b border-border flex items-center px-5 gap-4 shadow-pf z-50">
        <span className="font-serif text-[24px] text-pf-dark tracking-wide leading-none">Pfizer</span>
      ...
      <div className="h-[46px] flex-shrink-0 bg-card border-b border-border/80 flex items-center px-5 gap-1.5 overflow-x-auto">
