...
if __name__ == "__main__":
    ...
    test_briefs = [
        {
            "brief":   "Patient information page about our new oncology drug for cancer patients in Germany",
            "country": "Germany",
        ...
        {
            "brief":   "Internal team portal for the CXI+AI digital team to track project delivery",
            "country": "Global",
            "dept":    "CXI+AI",
        },
    ]
